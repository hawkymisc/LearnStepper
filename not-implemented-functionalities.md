...
| NIF-014 | AC-10, roadmap item 19 | Production maximum objective count and subject/stage rubrics | The acceptance test requires a declared upper bound, while roadmap item 19 leaves it undecided | Product policy for counts and rubric versions |
| NIF-015 | NFR privacy | Encryption, backup, export, and retention behavior | Data retention, encryption, backup, and export policy is undecided | Roadmap 10 |
| NIF-016 | NFR safety | Minor-user and high-risk-topic restrictions | Target age, parental consent, and medical/legal/financial boundaries are undecided | Roadmap 11 and 12 |
| NIF-017 | NFR diagnostics | External quality telemetry and crash reporting | External transmission is default-off and consent/scope are undecided | Roadmap 16 |
