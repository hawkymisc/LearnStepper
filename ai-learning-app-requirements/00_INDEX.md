...
### 2026-07-21 ハッカソン提出スコープ追補

現在の提出用focused MVPの実装範囲は[`docs/HACKATHON_SUBMISSION_DESIGN.md`](../docs/HACKATHON_SUBMISSION_DESIGN.md)
を優先します。本書群のMust分類は将来の完全版に対する要求として保持します。focused MVPでFuture Updateへ移した
教育課程準拠、診断、演習・採点、最終評価、補習、Web取得、全データ削除などは、今回の実装残件ではありません。
